#!/usr/bin/env node
/**
 * dev/capture.mjs — phone-frame captures of the live page at named scroll states (selector + offset).
 * Usage: node dev/capture.mjs http://127.0.0.1:8850/index.html?nowidget=1 dev/captures/v5
 */
...
await page.evaluate(() => document.querySelectorAll('.pr')[1].click()); await page.waitForTimeout(900)
